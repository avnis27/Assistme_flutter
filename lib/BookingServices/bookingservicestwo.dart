...
import 'package:assistme/WebCheckIn/mandotryWebCheckIn.dart';
...
class BookingCheckAirlines extends StatefulWidget {
  @override
  _BookingCheckAirlines createState() => _BookingCheckAirlines();
}

class _BookingCheckAirlines extends State<BookingCheckAirlines> {
  String itemType = "";
  var _airlines = [
    '   INDIGO AIRLINES',
    '   INDIGO',
  ...
  var _airlinesItemSelected = '   INDIGO AIRLINES';
  List<String> typeNeg = [
    "One",
    "Two",
    "Three",];
            ...
            child: DropdownButtonHideUnderline(
             ...
             DropdownButton<String>(
               ...
               style: TextStyle(
                ...
                items: _airlines.map((String dropDawnStringItem) {
                  return DropdownMenuItem<String>(
                    value: dropDawnStringItem,
                    child: Text(dropDawnStringItem,),
                  );
                }).toList(),
                onChanged: (String newAieLineValueSelected) =>
                    _onDropDownAirLinesItemSelected(newAieLineValueSelected),
                value: _airlinesItemSelected,
            ...
            child: FlatButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) =>
                        MandatoryWebCheck())); //MandatoryWebCheck()//BookingOne()
              },
              child: Text(
                'NEXT',
                style: TextStyle(
  ...
  void _onDropDownAirLinesItemSelected(String newAieLineValueSelected) {
    setState(() {
      this._airlinesItemSelected = newAieLineValueSelected;
    });
  }
}
